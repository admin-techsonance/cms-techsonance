  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">NFC Reader Devices</h2>
          <p className="text-muted-foreground">
            Manage IoT NFC reader hardware for attendance tracking
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Active and connected</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Select value={statusFilter} onValueChange={setStatusFilter}>
                <SelectTrigger className="w-[140px]" id="reader-status-filter">
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="mt-4 text-lg font-semibold">No reader devices</h3>
              <p className="text-sm text-muted-foreground mt-1">
                {search || statusFilter !== 'all'
                  ? 'Try adjusting your filters'
                  : 'Add an NFC reader device to get started'}
              </p>
            </div>
          ) : (
            <Table>
              ...
              <TableBody>
                {filteredReaders.map((reader) => (
                  <TableRow key={reader.id}>
                    <TableCell className="font-mono text-sm font-medium">{reader.readerId}</TableCell>
                    <TableCell>
      ...
      <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Add NFC Reader Device</DialogTitle>
            <DialogDescription>
              Register a new NFC reader device for attendance tracking.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="reader-ip-input">IP Address (optional)</Label>
              <Input
                id="reader-ip-input"
