...
const envSchema = z.object({
  ...
  SUPABASE_STORAGE_BUCKET_PAYROLL: z.string().min(1).optional(),
  SUPABASE_STORAGE_BUCKET_EXPENSES: z.string().min(1).optional(),
  SUPABASE_STORAGE_BUCKET_PROJECTS: z.string().min(1).optional(),
